...
from url import extract_contact_info
from whois import get_whois_info
app = Flask(__name__)

@app.route('/ara', methods=['POST'])
async def ara():
    print("11Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
    data = request.json
    ...
    try:
        print("12Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
        ...
        all_results = []
        print("13Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
        ...
        for result, contact_info in zip(all_results, contact_infos):
            print("14Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
        ...
        print("15Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
        return jsonify({"error": str(e)}), 500

@app.route('/')
def index():
    print("16Bitiiiiiiiiiiiiiiiiiiiiiiiiiii")
